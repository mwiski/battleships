...
public class EnemyBoardTest {
    ...
    private EnemyBoard testee = new EnemyBoard(12, e -> System.out.println("test"));
    ...
    public void testPlaceShipVertically() {
        ...
        Assert.assertEquals(Color.LIGHTBLUE, testee.getCell(0, 0). getFill());
        Assert.assertEquals(Color.LIGHTBLUE, testee.getCell(0, 1). getFill());
        Assert.assertEquals(Color.LIGHTBLUE, testee.getCell(0, 2). getFill());
    ...
    public void testPlaceShipHorizontally() {
        ...
        Assert.assertEquals(Color.LIGHTBLUE, testee.getCell(0, 0). getFill());
        Assert.assertEquals(Color.LIGHTBLUE, testee.getCell(1, 0). getFill());
        Assert.assertEquals(Color.LIGHTBLUE, testee.getCell(2, 0). getFill());
